        ...
        <section className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-6 border border-zinc-800 rounded-lg bg-zinc-900/40">
          ...
          <div className="flex flex-wrap gap-3 shrink-0">
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-accent text-black font-mono font-bold text-sm rounded hover:brightness-110 transition-all duration-200 shadow-[0_0_20px_rgba(0,217,255,0.25)]"
            >
